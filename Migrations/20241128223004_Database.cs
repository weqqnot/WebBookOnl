        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GenresGenreName = table.Column<string>(type: "nvarchar(100)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Books_Genres_GenresGenreName",
                        column: x => x.GenresGenreName,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookAuthor", x => new { x.BookId, x.AuthorName });
                    table.ForeignKey(
                        name: "FK_BookAuthor_Authors_AuthorName",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookGenre_Genres_GenreName",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookVouchers", x => new { x.BookId, x.VoucherId });
                    table.ForeignKey(
                        name: "FK_BookVouchers_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "BookId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookVouchers_Vouchers_VoucherId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GenreName = table.Column<string>(type: "nvarchar(100)", nullable: true),
                    OrderDetailId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Inventories", x => x.InventoryBookId);
                    table.ForeignKey(
                        name: "FK_Inventories_Authors_AuthorName",
                        column: x => x.AuthorName,
                        principalTable: "Authors",
                        principalColumn: "AuthorName");
                    table.ForeignKey(
                        name: "FK_Inventories_Genres_GenreName",
                        column: x => x.GenreName,
                        principalTable: "Genres",
                        principalColumn: "GenreName");
                    table.ForeignKey(
                        name: "FK_Inventories_OrderDetails_OrderDetailId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Books_GenresGenreName",
                table: "Books",
                column: "GenresGenreName");

            migrationBuilder.CreateIndex(
                name: "IX_BookVouchers_VoucherId",
                table: "BookVouchers",
                column: "VoucherId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inventories_AuthorName",
                table: "Inventories",
                column: "AuthorName");

            migrationBuilder.CreateIndex(
                name: "IX_Inventories_GenreName",
                table: "Inventories",
                column: "GenreName");

            migrationBuilder.CreateIndex(
                name: "IX_Inventories_OrderDetailId",
                table: "Inventories",
