    ...
    public partial class Database : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookForSale", x => new { x.BookId, x.Quantity });
                    table.ForeignKey(
                        name: "FK_BookForSale_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "BookId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookForSale_Inventories_Quantity",
                        column: x => x.Quantity,
