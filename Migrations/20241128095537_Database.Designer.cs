...
namespace WebBookShell.Migrations
{
    ...
    [Migration("20241128095537_Database")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebBookShell.Entities.BookForSale", b =>
                {
                    b.Property<int>("BookId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebBookShell.Entities.BookForSale", b =>
                {
                    b.HasOne("WebBookShell.Entities.Book", "Book")
                        .WithMany("BookForSale")
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebBookShell.Entities.Inventory", "Inventory")
                        .WithMany("BookForSale")
